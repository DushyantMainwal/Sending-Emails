package com.dushyant.sendemail;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendEmail() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    GMailSender sender = new GMailSender("your_email@gmail.com", "your_password");//From
                    sender.sendMail( "Subject: Sent From Dushyant Mainwal",
                            "This is the email body",
                            "your_email@gmail.com",
                            "sender_email@gmail.com");//To
                } catch (Exception e) {
        ...
        switch (requestCode) {
            case Utils.REQUEST_GOOGLE_PLAY_SERVICES:
                if (resultCode != RESULT_OK) {
                    showMessage(sendButton, "This app requires Google Play Services. Please install " +
                            "Google Play Services on your device and relaunch this app.");
                } else {
                    getResultsFromApi(sendButton);
                }
                break;
